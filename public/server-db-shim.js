window.ServerDB = {
  ...
  updateDriver: async function(id, upd){ const r = await fetch('/api/drivers?id='+encodeURIComponent(id), { method:'PUT', headers:{'content-type':'application/json'}, body: JSON.stringify(upd)}); return r.json(); },
